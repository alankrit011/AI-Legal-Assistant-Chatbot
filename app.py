...
st.set_page_config(page_title="AILA", layout="wide")
...
def show_description():
    ...
    current_image = st.slider("Select an Image", 0, len(images) - 1, 0)
    st.image(images[current_image], caption='AI Legal Assistant', use_column_width=True)
...
if not st.session_state.show_chat:
    ...
    st.image("AILA.jpg", use_column_width=True)
...
st.markdown("""
    <footer style='text-align: center; padding: 10px;'>
        <p>Contact us: info@aila.com | Phone: +91 123 456 7890</p>
    </footer>
